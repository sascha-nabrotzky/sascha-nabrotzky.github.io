  ...
  return (
    <Layout>
      ...
      <p>
        ...
        Datenschutz hat einen besonders hohen Stellenwert für den UX-Engineer
        Sascha Nabrotzky. Eine Nutzung der Internetseiten von UX-Engineer Sascha
        Nabrotzky ist grundsätzlich ohne jede Angabe personenbezogener Daten
      ...
      <p>
        ...
        Übereinstimmung mit den für UX-Engineer Sascha Nabrotzky geltenden
      ...
      <p>
        UX-Engineer Sascha Nabrotzky hat als für die Verarbeitung
      ...
      <p>
        Die Datenschutzerklärung von UX-Engineer Sascha Nabrotzky beruht auf den
      ...
      <p>UX-Engineer Sascha Nabrotzky</p>
      <p>Koldefeld, 11</p>
      <p>49549 Ladbergen</p>
      <p>Deutschland</p>
      <p>Tel.: 05485207979</p>
      ...
      <p>
        Die Internetseite der UX-Engineer Sascha Nabrotzky erfasst mit jedem
      ...
      <p>
        ...
        UX-Engineer Sascha Nabrotzky keine Rückschlüsse auf die betroffene
        ...
        erhobenen Daten und Informationen werden durch die UX-Engineer Sascha
        Nabrotzky daher einerseits statistisch und ferner mit dem Ziel
      ...
      <p>
        Auf der Website von Frontent-Entwickler Sascha Nabrotzky ist kein
        Kontaktformular vorhanden. Besucher können über einen mailto-Link auf
        der Webseite Nachrichten an ihn übermitteln. Um eine Antwort empfangen
        zu können, ist zumindest die Angabe einer gültigen E-Mail-Adresse
        erforderlich. Alle weiteren Angaben kann die anfragende Person
        freiwillig geben. Mit Absenden der Nachricht über den jeweiligen
        E-Mail-Client willigt der Besucher in die Verarbeitung der übermittelten
        personenbezogenen Daten ein.
      </p>

      <p>
        Die Datenverarbeitung erfolgt ausschließlich zu dem Zweck der Abwicklung
        und Beantwortung von Anfragen über den mailto-Link. Dies geschieht auf
        Basis der freiwillig erteilten Einwilligung gem. Art. 6 Abs. 1 Satz 1
        Buchst. a. DSGVO. Die für die Benutzung des mailto-Links erhobenen
        personenbezogenen Daten werden automatisch gelöscht, sobald die Anfrage
        erledigt ist und keine Gründe für eine weitere Aufbewahrung gegeben
        sind.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            UX-Engineer Sascha Nabrotzky gespeichert sind, veranlassen möchte,
            kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
            Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der
            UX-Engineer Sascha Nabrotzky wird veranlassen, dass dem
            Löschverlangen unverzüglich nachgekommen wird.
          </p>

          <p>
            Wurden die personenbezogenen Daten von der UX-Engineer Sascha
            Nabrotzky öffentlich gemacht und ist unser Unternehmen als
            Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
            personenbezogenen Daten verpflichtet, so trifft die UX-Engineer
            Sascha Nabrotzky unter Berücksichtigung der verfügbaren Technologie
            ...
            Mitarbeiter der UX-Engineer Sascha Nabrotzky wird im Einzelfall das
        ...
        <li>
          ...
          <p>
            ...
            bei der UX-Engineer Sascha Nabrotzky gespeichert sind, verlangen
            ...
            UX-Engineer Sascha Nabrotzky wird die Einschränkung der Verarbeitung
            veranlassen.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            betroffene Person jederzeit an einen Mitarbeiter der UX-Engineer
            Sascha Nabrotzky wenden.
          </p>
        </li>
        <li>
          ...
          <p>
            Die UX-Engineer Sascha Nabrotzky verarbeitet die personenbezogenen
          ...
          <p>
            Verarbeitet die UX-Engineer Sascha Nabrotzky personenbezogene Daten,
            ...
            Person gegenüber der UX-Engineer Sascha Nabrotzky der Verarbeitung
            für Zwecke der Direktwerbung, so wird die UX-Engineer Sascha
            Nabrotzky die personenbezogenen Daten nicht mehr für diese Zwecke
            verarbeiten.
          </p>
          ...
          <p>
            ...
            Verarbeitung personenbezogener Daten, die bei der UX-Engineer Sascha
            Nabrotzky zu wissenschaftlichen oder historischen Forschungszwecken
          ...
          <p>
            ...
            Person direkt an jeden Mitarbeiter der UX-Engineer Sascha Nabrotzky
        ...
        <li>
          ...
          <p>
            ...
            der betroffenen Person, trifft die UX-Engineer Sascha Nabrotzky
